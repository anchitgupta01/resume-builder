/*
  # Complete Authentication and Resume Management Schema

  1. New Tables
    - `resumes` - Store user resume data with versioning support
    - `chat_history` - Store AI chat conversations per user/resume
    - `templates` - Admin-managed resume templates
  ...
  2. Security
    ...
    - Analytics tracking with proper permissions
  ...
  4. User Management
    ...
    - Proper cascade deletes for data cleanup
*/
