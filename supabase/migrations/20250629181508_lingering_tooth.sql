...
-- Add additional columns to templates table if they don't exist
DO $$
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'templates' AND column_name = 'level') THEN
    ALTER TABLE templates ADD COLUMN level text;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'templates' AND column_name = 'preview') THEN
    ALTER TABLE templates ADD COLUMN preview text;
  END IF;
...
BEGIN
  ...
  -- Create policy without is_active condition (safer)
...
-- Create template indexes only if columns exist
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'templates' AND column_name = 'category') THEN
    CREATE INDEX IF NOT EXISTS idx_templates_category ON templates(category);
  END IF;
  
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'templates' AND column_name = 'level') THEN
    CREATE INDEX IF NOT EXISTS idx_templates_level ON templates(level);
  END IF;
  
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'templates' AND column_name = 'is_active') THEN
...
-- Insert sample template only if all required columns exist
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'templates' AND column_name = 'category') AND
     EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'templates' AND column_name = 'level') AND
     EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'templates' AND column_name = 'tags') AND
     EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'templates' AND column_name = 'preview') AND
     EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'templates' AND column_name = 'is_active') THEN
    ...
    ON CONFLICT (id) DO NOTHING;
  ELSE
    -- Simplified template insert if not all columns exist
