/*
  ...
  1. New Tables
    - `resumes` - Store user resume data with versioning support
    - `chat_history` - Store AI chat conversations linked to resumes
    - `templates` - Store admin-managed resume templates
    - `analytics` - Track user events and usage analytics
