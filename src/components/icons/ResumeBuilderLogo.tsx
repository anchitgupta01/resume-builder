...
export function ResumeBuilderLogo({ className = "w-full h-full", size }: ResumeBuilderLogoProps) {
  ...
  return (
    ...
    >
      ...
      <g transform="translate(140, 60)">
        ...
        {/* Neural connections */}
        <line x1="-6" y1="-6" x2="6" y2="6" stroke="url(#aiGradient)" strokeWidth="2" opacity="0.7"/>
        <line x1="6" y1="-6" x2="-6" y2="6" stroke="url(#aiGradient)" strokeWidth="2" opacity="0.7"/>
        ...
        {/* Connection lines */}
        <line x1="-8" y1="-8" x2="-12" y2="-12" stroke="url(#aiGradient)" strokeWidth="1.5" opacity="0.6"/>
        <line x1="8" y1="-8" x2="12" y2="-12" stroke="url(#aiGradient)" strokeWidth="1.5" opacity="0.6"/>
        <line x1="-8" y1="8" x2="-12" y2="12" stroke="url(#aiGradient)" strokeWidth="1.5" opacity="0.6"/>
        <line x1="8" y1="8" x2="12" y2="12" stroke="url(#aiGradient)" strokeWidth="1.5" opacity="0.6"/>
      </g>
      ...
      <circle cx="100" cy="100" r="90" fill="none" stroke="url(#aiGradient)" strokeWidth="1" opacity="0.3"/>
    </svg>
  );
}